...
namespace vulkan
{
   ...
   public:
      ...
      VkPhysicalDeviceMemoryProperties m_vkphysicalddevicememoryproperties;
   ...
   ///public:
      ...
      ::string_array    m_straEnabledDeviceExtensions;
      ::string_array    m_straEnabledInstanceExtensions;
      ::string          m_strTitle;
      ::string          m_strWindowClassName;
      uint32_t          m_uiApiVersion;
      ...
      virtual ::string_array get_instance_extensions();
