...
namespace std
{
	...
	{
		return std::unique_ptr<T>(___new T(std::forward<Args>(args)...));
	}
}
...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "vulkanExample"_ansi, __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "vulkanExample"_ansi, __VA_ARGS__))
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "vulkanExample"_ansi, __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "vulkanExample"_ansi, __VA_ARGS__))
