...
VulkanExample2::~VulkanExample2()
   ...
   void VulkanExample2::prepareOffscreen()
   {
      ...
      offscreenPass.color.size = memReqs.size;
   ...
   void VulkanExample2::buildCommandBuffers()
   {
   ...
   void VulkanExample2::loadAssets()
   {
   ...
   void VulkanExample2::setupDescriptors()
   {
      // Pool
   ...
   void VulkanExample2::preparePipelines()
   {
      // Layouts
   ...
   void VulkanExample2::prepareUniformBuffers()
   {
   ...
   void VulkanExample2::updateUniformBuffers()
   {
   ...
   void VulkanExample2::updateUniformBufferOffscreen()
   {
      uniformData.projection = camera.matrices.perspective;
      uniformData.view = camera.matrices.view;
      uniformData.model = glm::mat4(1.0f);
   ...
   void VulkanExample2::OnUpdateUIOverlay(vks::UIOverlay * overlay)
   {
...
{																									
	vulkanExample = ___new VulkanExample2();															
...
void VulkanExample2::renderLoop2(const ::function < void(void *, int, int, int)> & callback)
{
...
//{																									\
//	for (int32_t i = 0; i < __argc; i++) { VulkanExample2::args.push_back(__argv[i]); };  			\
//	vulkanExample = ___new VulkanExample2();															\
//	vulkanExample->initVulkan();																	\
...
//	state->onAppCmd = VulkanExample2::handleAppCommand;												\
//	state->onInputEvent = VulkanExample2::handleAppInput;											\
//	androidApp = state;																				\
...
//{																									\
//	for (size_t i = 0; i < argc; i++) { VulkanExample2::args.push_back(argv[i]); };  				\
//	vulkanExample = ___new VulkanExample2();															\
//	vulkanExample->initVulkan();																	\
//	vulkanExample->prepare();																		\
//	vulkanExample->renderLoop();																	\
...
//int main(const int argc, const char *argv[])														
//{																									
//	for (int i = 0; i < argc; i++) { VulkanExample2::args.push_back(argv[i]); };						
//	vulkanExample = ___new VulkanExample2();															
//	vulkanExample->initVulkan();																	
//	vulkanExample->setupWindow();																	
//	vulkanExample->prepare();																		
