...
namespace vulkan1
{
   ...
   ::comparable_array <const char*> base_application_with_swap_chain::get_instance_extensions()
   {


      ::comparable_array <const char*> pszInstanceExtensions;

      // Enable surface extensions depending on os
#if defined(_WIN32)
      pszInstanceExtensions.add(VK_KHR_WIN32_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_ANDROID_KHR)
      pszInstanceExtensions.add(VK_KHR_ANDROID_SURFACE_EXTENSION_NAME);
#elif defined(_DIRECT2DISPLAY)
      pszInstanceExtensions.add(VK_KHR_DISPLAY_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_DIRECTFB_EXT)
      pszInstanceExtensions.add(VK_EXT_DIRECTFB_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_WAYLAND_KHR)
      pszInstanceExtensions.add(VK_KHR_WAYLAND_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_XCB_KHR)
      pszInstanceExtensions.add(VK_KHR_XCB_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_IOS_MVK)
      pszInstanceExtensions.add(VK_MVK_IOS_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_MACOS_MVK)
      pszInstanceExtensions.add(VK_MVK_MACOS_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_METAL_EXT)
      pszInstanceExtensions.add(VK_EXT_METAL_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_HEADLESS_EXT)
      pszInstanceExtensions.add(VK_EXT_HEADLESS_SURFACE_EXTENSION_NAME);
#elif defined(VK_USE_PLATFORM_SCREEN_QNX)
      pszInstanceExtensions.add(VK_QNX_SCREEN_SURFACE_EXTENSION_NAME);
#endif

      return pszInstanceExtensions;
...
//      if (m_pszaEnabledInstanceExtensions.size() > 0)
//      {
//         for (const char* enabledExtension : m_pszaEnabledInstanceExtensions)
//         {
//            // Output message if requested extension is not available
//            if (std::find(supportedInstanceExtensions.begin(), supportedInstanceExtensions.end(), enabledExtension) == supportedInstanceExtensions.end())
//            {
//               std::cerr << "Enabled m_vkinstance extension \""_ansi << enabledExtension << "\" is not present at m_vkinstance level\n"_ansi;
//            }
...
//      if (m_settings.m_bValidation || std::find(supportedInstanceExtensions.begin(), supportedInstanceExtensions.end(), VK_EXT_DEBUG_UTILS_EXTENSION_NAME) != supportedInstanceExtensions.end()) {
...
//      if (m_settings.m_bUIOverlay) {
//         m_uioverlay.m_vkdevice = m_pvulkandevice;
...
//      VkResult result = m_swapchain.acquireNextImage(m_semaphores.m_vksemaphorePresentComplete, &m_uiCurrentBuffer);
...
//   {
//      VkResult result = m_swapchain.queuePresent(m_vkqueue, m_uiCurrentBuffer, m_semaphores.m_vksemaphoreRenderComplete);
...
//      //	commandLineParser.add("m_bFullScreen"_ansi, { "-f"_ansi, "--m_bFullScreen"_ansi }, 0, "Start in m_bFullScreen mode"_ansi);
...
//      //	}
//      //	if (commandLineParser.isSet("m_bFullScreen"_ansi)) {
//      //		m_settings.m_bFullScreen = true;
//      //	}
...
//      if (this->m_settings.m_bValidation)
//      {
...
//   }
   ...
   bool base_application_with_swap_chain::initVulkan()
   {
      ...
      m_swapchain.setContext(m_vkinstance, m_vkphysicaldevice, m_vkdevice);
...
//   {
//      m_swapchain.create(&m_iWidth, &m_iHeight, m_settings.vsync, m_settings.m_bFullScreen);
//   }
