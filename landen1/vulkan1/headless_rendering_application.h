...
namespace vulkan1
{
   ...
   class headless_rendering_application :
   ...
   //   FrameBufferAttachment m_attachmentColor, m_depthAttachment;
   ...
   //   VkDebugReportCallbackEXT m_debugReportCallback{};
      ...
      headless_rendering_application(mouse_state* pmousestate);
      ~headless_rendering_application();
      ...
      bool initVulkan();
      void submitWork(VkCommandBuffer cmdBuffer, VkQueue m_vkqueue);
   ...
   class headless_application :
      public headless_rendering_application
   {
   public:
      ...
      headless_application(mouse_state* pmousestate);
